...
cmd = "/usr/local/astrometry/bin/solve-field " + jpg_file + " --overwrite --width=640 --height=360 --width=640 --scale-low 50 --scale-high 95 --no-remove-lines --x-column x --y-column y"
print (cmd)
os.system(cmd)
