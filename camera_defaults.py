...
import requests
from amslibs import read_config
...
url = "http://" + str(cam_ip) + "/cgi-bin/videocoding_cgi?action=set&user=admin&pwd=admin&channel=0&EncType1=H.264&Resolution1=1280*720&BitflowType1=VBR&KeyInterval1=20&Bitrate1=512&FrameRate1=20&Profile1=Baseline&PicLevel1=1"

print (url)
r = requests.get(url)
print r.text

url = "http://" + str(cam_ip) + "/cgi-bin/videocoding_cgi?action=set&user=admin&pwd=admin&channel=0&EncType2=H.264&Resolution2=640*480&KeyInterval2=20&FrameRate2=20&BitflowType2=VBR&NormalBitrate2=512&PicLevel2=1&Profile2=Baseline&quality2=1&ratectrl2=1"
print (url)
r = requests.get(url)
print r.text
